...
//http://www.java2s.com/Open-Source/Android/android-core/platform-frameworks-base/com/android/internal/widget/PointerLocationView.java.htm
//PointerLocationView.java :  » android-core » platform-frameworks-base » com » android » internal » widget » Android Open Source
//Android Open Source » android core » platform frameworks base	 	
//platform frameworks base » com » android » internal » widget » PointerLocationView.java
...
public class RubuxptrActivityView extends View {
    ...
    public RubuxptrActivityView(Context c) {
        super(c);
        setFocusable(true);
    ...
    public void addTouchEvent(MotionEvent event) {
        synchronized (mPointers) {
            ...
            // SEND the mouse move TODO: smooth it over
            RubuxSocket.txMouseMove(ps.mXVelocity, ps.mYVelocity);
